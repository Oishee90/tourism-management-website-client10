...
const Header = () => {
    ...
    // Apply the dark/light theme only for the home page
    const navbarClass = isHomePage && isdark ? 'text-white' : 'text-[#03070CB3]';
    const navbarHeading = isHomePage && isdark ? 'text-[#be8fce]' : 'text-[#86469C]';
    const navbarbg = isHomePage && isdark ? 'bg-[#be8fce]' : 'bg-[#86469C]';
 ...
 {user.displayName}
  ...
  <div className="dropdown dropdown-end ml-2">
      ...
      <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow rounded-box w-52">
       ...
       <Link to={'/register'}><li className={`font-raleway rounded-lg mb-3 font-bold text-lg bg-[#FC4100]  text-white`}><a>Register</a></li></Link> 
