...
<div className="font-ubuntu my-8 text-center space-y-6">
  <h1 className="text-2xl lg:text-4xl font-extrabold text-[#131318]">Clients Question</h1>
           ...
           <div className="relative">
            ...
            <div className="space-y-5">
              <div className="collapse collapse-plus border-b-2 rounded-none border-[#1313181A]">
                ...
                <div className="collapse-title font-raleway text-left text-xl text-[#131318] font-bold">
                  Our Equipment
                </div>
                <div className="collapse-content"> 
                  <p className="font-raleway text-[#13131899] text-left"> 
              ...
              <div className="collapse collapse-plus border-b-2 rounded-none border-[#1313181A]">
                <input type="radio" name="my-accordion-3" /> 
                <div className="collapse-title font-rakeway text-left text-xl text-[#131318] font-bold">
              ...
              <div className="collapse collapse-plus border-b-2 rounded-none border-[#1313181A]">
                ...
                <div className="collapse-content"> 
                  <p className="font-raleway text-[#13131899] text-left">Streamline your journey with JourneySEA s hassle-free booking system. Our intuitive platform makes reserving your spot for tours, lessons, or excursions effortless, so you can focus on the 
              </p>
                </div>
              </div>
              <div className="collapse collapse-plus border-b-2 rounded-none border-[#1313181A]">
                ...
                <div className="collapse-content"> 
                  <p className="font-manrop text-[#13131899] text-left">At JourneySEA, we understand the importance of transparency. Feel free to reach out with any inquiries regarding our pricing options. Our dedicated team is here to provide you with detailed information and assist you in selecting the perfect package for your adventure needs.
