...
const Explore = () => {
  ...
  <h1 className="text-2xl lg:text-4xl font-extrabold text-[#131318]">Explore Boundless Possibilities</h1>
  <p className="text-base">With JourneySEA, every adventure is an opportunity to explore, discover, and create unforgettable memories.
   ...
   <div className="grid  mt-7 lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-5 m-5 ">
    <div className="card flex flex-col justify-center items-start gap-0  py-10 ">
        <h1 className="font-ubuntu text-lg md:text-3xl font-medium">Go beyond your <br />imagination</h1>
...
<p className="font-raleway text-base md:text-xl">Discover your ideal experience with us</p>
    ...
    <Fade triggerOnce={true} cascade={false} delay={10} direction="up">
...
<Fade triggerOnce={true} cascade={false} delay={20} direction="up">
    <div className="card  bg-base-100 shadow-xl image-full h-[100%]">
...
<Fade triggerOnce={true} cascade={false} delay={30} direction="up">
    <div className="card  bg-base-100 shadow-xl image-full h-[100%]">
