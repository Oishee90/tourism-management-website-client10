...
<footer className="bg-gray-300 dark:bg-gray-900">
   ...
   <p  className="mt-5 mb-5 text-base md:text lg">Stay Connected with JourneySEA</p>
   <p className=" text-base md:text lg"> Follow Us on Social Media for Exclusive Offers, Travel Tips, and Inspiring Adventures!</p>
    </div>
    ...
    <div>
        ...
        <div className="flex  items-center gap-2 mt-0">
               <MdAddCall  className=" text-[#FF4240] fill-current font-extrabold w-[24px] h-[24px]"></MdAddCall >
            <h3 className="py-2 font-bold font-raleway text-black ">Phone Number : (+62) 123-321-543</h3></div>
            <div className="flex  items-center gap-2 mt-0">
              <MdMarkEmailRead  className="text-[#FF4240] fill-current font-extrabold w-[24px] h-[24px]"></MdMarkEmailRead >
              <h3 className="py-2 font-bold font-raleway text-black ">Email : journeysea@support.com</h3></div>
              <div className="flex  items-center gap-2 mt-0">
              <MdOutlineAddLocationAlt  className="text-[#FF4240] fill-current font-extrabold w-[24px] h-[24px]"></MdOutlineAddLocationAlt >
  ...
  <aside>
    <p className='text-black font-bold'>Copyright © 2024 - All right reserved by JourneySEA</p>
  </aside>
</footer>
    </div>
</footer>
